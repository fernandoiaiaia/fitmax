...
console.log('==================================================');
console.log('♿ INICIANDO AUDITORIA DE ACESSIBILIDADE - WEB-CLIENT');
console.log('==================================================');
...
(async () => {
  ...
  try {
    ...
    console.log('\n📝 Preenchendo credenciais do paciente para autenticação...');
  ...
  console.log('\n==================================================');
  console.log('📊 BALANÇO GERAL DE VIOLAÇÕES DE ACESSIBILIDADE (WEB-CLIENT)');
  console.log('==================================================');
  ...
  if (totalFalhasGraves > 0) {
    ...
    console.log('♿ O portal do paciente está em conformidade com as diretrizes de acessibilidade!');
    console.log('==================================================\n');
    process.exit(0);
  }
})();
