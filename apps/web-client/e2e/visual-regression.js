...
// Teste de Regressão Visual E2E (Item 11) para FITMAX Web Client (Portal do Paciente)
...
(async () => {
  console.log('==================================================');
  console.log('📸 INICIANDO AUDITORIA DE REGRESSÃO VISUAL - CLIENT');
  console.log('==================================================\n');
  ...
  try {
    const screens = [
      ...
      },
      {
        name: 'dashboard-page',
        navigate: async () => {
          console.log(`\n🌐 [Rota] Efetuando login e acessando o Dashboard do Paciente...`);
          await page.goto(`${FRONTEND_URL}`, { waitUntil: 'networkidle2' });
          await page.waitForSelector('input#email');
