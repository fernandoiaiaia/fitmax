    ...
    <div className="login-page">
      ...
      <div className="login-split">
        ...
        <div className="login-split__form">
          ...
          <div className="ls-logo">
            <div className="ls-logo-brand">
              ...
              <div className="ls-logo-brand__text">
                ...
                <span className="ls-logo-brand__badge">Pro</span>
              </div>
            </div>
          </div>
          ...
          {/* Google */}
          <button type="button" className="ls-google" id="btn-google-login">
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="ls-form" id="form-login-pro">
            {/* E-mail */}
            <div className="ls-field">
              <label htmlFor="pro-email" className="ls-field__label">E-mail profissional</label>
              <input
                id="pro-email"
                type="email"
                value={email}
            ...
            <div className="ls-field">
              <div className="ls-field__label-row">
                <label htmlFor="pro-password" className="ls-field__label">Senha</label>
