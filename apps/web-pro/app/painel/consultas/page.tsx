...
const consultas: Consulta[] = [
  ...
  },
  {
    ...
    horario: "15:30",
    nome: "Ricardo Nunes",
    especialidade: "Check-up Cardíaco",
    modalidade: "Presencial",
    data: "Hoje, 23/04",
  ...
  },
  {
    ...
    horario: "14:00",
    nome: "Carlos Eduardo",
    especialidade: "Avaliação Cardíaca",
    modalidade: "Presencial",
    data: "25/04",
      ...
      <div className="cns-header">
        ...
        <div className="cns-header__controls">
          <button className="cns-ctrl-btn" id="btn-filtro-periodo">
            <CalendarIcon />
            <span>23/04/2026 — 23/05/2026</span>
            <FilterIcon />
          </button>
          ...
          <div className="cns-card">
            ...
            <div className="cns-resumo-grid">
              <div className="cns-resumo-item">
                ...
                <p className="cns-resumo-item__meta">Agendamentos</p>
                <p className="cns-resumo-item__value">142</p>
                <p className="cns-resumo-item__trend">+12% vs mês anterior</p>
              </div>
              <div className="cns-resumo-item">
                <div className="cns-resumo-item__icon">
                  <MoneyIcon />
                </div>
                <p className="cns-resumo-item__meta">Valor Gerado</p>
                <p className="cns-resumo-item__value">R$8.400</p>
