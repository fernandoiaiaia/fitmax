...
export default function PainelLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="pro-layout">
      ...
      {/* ═══════════════ SIDEBAR ═══════════════ */}
      <aside
        className={`pro-sidebar ${collapsed ? "pro-sidebar--collapsed" : ""} ${mobileOpen ? "pro-sidebar--open" : ""}`}
      >
            ...
            <>
              ...
              <div className="pro-profile__stats">
                ...
                <div className="pro-profile__stat">
                  ...
                  <span className="pro-profile__stat-lbl">Esta semana</span>
                </div>
              </div>
            </>
          )}
      ...
      <div className="pro-right">
        ...
        <header className="pro-topbar">
          ...
          <div className="pro-topbar__search">
            <span className="pro-topbar__search-icon">
              <Icon name="search" />
            </span>
            <input
              id="topbar-search"
