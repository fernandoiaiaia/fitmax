...
console.log('==================================================');
console.log('♿ INICIANDO AUDITORIA DE ACESSIBILIDADE - WEB-PRO');
console.log('==================================================');
...
(async () => {
  ...
  try {
    ...
    console.log('\n📝 Preenchendo credenciais do profissional para autenticação...');
  ...
  console.log('\n==================================================');
  console.log('📊 BALANÇO GERAL DE VIOLAÇÕES DE ACESSIBILIDADE (WEB-PRO)');
  console.log('==================================================');
  ...
  if (totalFalhasGraves > 0) {
    ...
    console.log('♿ O portal do profissional está em conformidade com as diretrizes de acessibilidade!');
    console.log('==================================================\n');
    process.exit(0);
  }
})();
